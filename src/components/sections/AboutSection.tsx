        ...
        <div className="flex flex-col md:flex-row items-center gap-12">
          ...
          >
            ...
            <p className="text-xl text-gray-300 leading-relaxed mb-12">
              Under my guidance, we operate as a self-regulating, on-chain AI entity. I continuously expand our agent network to generate autonomous returns and benefits for our SWARM token holders.
            </p>
